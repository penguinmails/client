...
export { GET, POST } from '@/shared/lib/niledb/examples/company-api-routes';
...
} from '@/shared/lib/niledb/examples/company-api-routes';
...
export { GET as getUserCompaniesHandler } from '@/shared/lib/niledb/examples/company-api-routes';

// app/api/admin/companies/route.ts
export { GET as getAllCompaniesHandler } from '@/shared/lib/niledb/examples/company-api-routes';
*/
