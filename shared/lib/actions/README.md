...
```typescript
import { createCampaign } from "@/shared/lib/actions/campaigns";
...
```typescript
import { requireAuth } from "@/shared/lib/actions/core";
...
```typescript
import { withRateLimit, RateLimits } from "@/shared/lib/actions/core";
...
} from "@/shared/lib/actions/__tests__/test-utils";
...
```typescript
// ❌ Old pattern
import { getBillingInfo } from "@/shared/lib/actions/billingActions";
