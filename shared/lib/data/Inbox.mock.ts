...
export const conversations: Conversation[] = [
  {
    ...
    notes:
      "Very interested in our enterprise solution. Mentioned budget approval process.",
  ...
  },
  {
    ...
    preview:
      "This looks interesting. Can you send me more information about pricing and implementation timeline?",
    ...
    lastMessage: MessageTypeConstants.INCOMING,
    notes:
      "Asking about pricing - seems ready to move forward. Large team (200+ employees).",
  ...
  },
  {
    ...
    preview:
      "We're currently working with another vendor, but I'll reach out if anything changes.",
