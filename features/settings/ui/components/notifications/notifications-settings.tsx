    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        const preferences: SimpleNotificationPreferences = {
          newReplies: result.data.emailNotifications ?? true,
          campaignUpdates: result.data.campaignUpdates ?? true,
          weeklyReports: result.data.weeklyReports ?? true,
          domainAlerts: result.data.systemAlerts ?? true,
          warmupCompletion: result.data.marketingEmails ?? false,
        ...
        form.reset({
          newReplies: preferences.newReplies,
          campaignUpdates: preferences.campaignUpdates,
          weeklyReports: preferences.weeklyReports,
          domainAlerts: preferences.domainAlerts,
          warmupCompletion: preferences.warmupCompletion,
        });
      ...
      productionLogger.error("Error fetching notification preferences:", err);
  ...
  const onSubmit = (data: NotificationFormValues) => {
    startTransition(async () => {
      try {
        ...
        productionLogger.error("Error updating notification preferences:", err);
        toast.error("Update failed", {
