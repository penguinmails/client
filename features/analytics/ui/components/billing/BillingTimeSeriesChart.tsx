...
/**
 * Billing-specific time series data point structure.
 */
interface BillingTimeSeriesDataPoint {
  label: string;
  usage: {
    emailsSent: number;
  };
...
interface BillingTimeSeriesChartProps {
  timeSeriesData: BillingTimeSeriesDataPoint[] | null;
}
      ...
      <CardContent>
        ...
        <div className="mt-4 space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
            {timeSeriesData
              .slice(-3)
              .map((point: BillingTimeSeriesDataPoint, index: number) => (
                <div
                  key={index}
