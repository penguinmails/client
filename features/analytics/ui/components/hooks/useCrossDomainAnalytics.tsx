...
} from "@features/analytics/lib/services";
...
} from "@features/analytics/actions/cross-domain-analytics";
...
export function useCrossDomainAnalytics(
  ...
  const fetchRawData = useCallback(async () => {
    ...
    try {
      ...
      productionLogger.error('Error fetching cross-domain analytics:', err);
