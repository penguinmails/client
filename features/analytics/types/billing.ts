...
/**
 * Summary data interface for billing dashboard cards.
 * Matches the SummaryCards component expectations.
 */
...
/**
 * Limit alerts interface for usage monitoring.
 * Matches the UsageAlertsCard component expectations.
 */
export interface LimitAlerts {
  totalAlerts: number;
  alerts: UsageAlert[];
}

/**
 * Usage alert interface for individual alerts.
 */
...
/**
 * Plan utilization interface for plan monitoring.
 */
...
/**
 * Usage recommendations interface for optimization suggestions.
 */
