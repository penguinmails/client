  ...
  return (
    <div className="bg-white dark:bg-card shadow rounded-lg">
      <div className="px-4 py-5 sm:p-6">
        <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-foreground mb-4">Filters</h3>

        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          {/* Search Input */}
          <div>
            <label htmlFor="search" className="block text-sm font-medium text-gray-700 dark:text-foreground">
              Search
            </label>
            <input
              type="text"
          ...
          {/* Role Filter */}
          <div>
            <label htmlFor="role" className="block text-sm font-medium text-gray-700 dark:text-foreground">
              Role
            </label>
            <select
              id="role"
          ...
          <div className="flex items-end">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="staff-only" className="ml-2 block text-sm text-gray-900 dark:text-foreground">
                Staff Only
              </label>
            </div>
          </div>
