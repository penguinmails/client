...
import { copyText } from "@features/domains/ui/components/copy";
...
async function verifyDnsRecord(
  ...
  try {
    ...
    productionLogger.error("DNS verification error");
  ...
  useEffect(() => {
    const fetchDomainData = async () => {
      try {
        ...
        productionLogger.error("Failed to load domain data");
      } finally {
        setIsLoading(false);
      }
    };
