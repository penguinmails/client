...
// TODO: Create missing inbox action functions
// import { hideEmailAction, markEmailAsReadAction, softDeleteEmailAction } from "@features/inbox/actionsActions";
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuContent,
...
// TODO: Create missing inbox action functions
// const hideEmailAction = async (id: IdType) => { /* implement */ };
// const markEmailAsReadAction = async (id: IdType) => { /* implement */ };
// const softDeleteEmailAction = async (id: IdType) => { /* implement */ };
...
export function InboxColumnAction({
  ...
  const markAsReadMutation = async (_id: IdType) => {
    try {
      // TODO: Implement markEmailAsReadAction
      ...
      productionLogger.error("Error marking email as read", error);
    }
  };
  const deleteEmailMutation = async (_id: IdType) => {
    try {
      // TODO: Implement softDeleteEmailAction
      ...
      productionLogger.error("Error deleting email", error);
    }
  };
  const hideEmailMutation = async (_id: IdType) => {
    try {
      // TODO: Implement hideEmailAction
      ...
      productionLogger.error("Error hiding email", error);
    }
  };
