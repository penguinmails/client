...
/**
 * MigratedRecipientsSettings - Recipients settings using Design System components
 * 
 * Uses DS Button and maintains consistent typography with text-muted-foreground.
 */
export function MigratedRecipientsSettings({
  recipients,
...
export default MigratedRecipientsSettings;
