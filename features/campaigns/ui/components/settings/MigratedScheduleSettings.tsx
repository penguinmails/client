...
/**
 * MigratedScheduleSettings - Schedule settings using Design System components
 * 
 * Uses TextFormField and SelectFormField from DS, plus DS Button for day toggles.
 */
export function MigratedScheduleSettings(props: ScheduleSettingsProps) {
...
export default MigratedScheduleSettings;
