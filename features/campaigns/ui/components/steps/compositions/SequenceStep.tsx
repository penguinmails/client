...
import { SequenceStepProps } from "@features/campaigns/types";
...
export function SequenceStep({
  ...
  return (
    <div className="relative group">
      ...
      {index < totalSteps - 1 && (
        <div className="absolute top-full h-6 border-l-2 border-dashed border-gray-300 dark:border-gray-700" />
      )}
