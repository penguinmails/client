...
export interface EmailStep {
  ...
  condition?: "always" | "no_reply" | "ALWAYS" | "IF_NOT_OPENED" | "IF_NOT_CLICKED" | "IF_NOT_REPLIED" | "IF_OPTION_A" | "IF_OPTION_B" | "IF_OPTION_C" | "IF_OPTION_D" | "IF_OPTION_E" | "IF_UNSUBSCRIBED";
  // Campaign step properties
        ...
        <div>
          ...
          <div className="border border-border rounded-xl">
            ...
            {!isPreviewMode ? (
              ...
              <div
                className="px-4 py-3 min-h-40 rounded-none rounded-b-xl bg-muted/50 dark:bg-muted/30 border-0"
