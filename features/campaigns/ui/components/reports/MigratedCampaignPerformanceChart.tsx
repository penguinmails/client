...
interface MigratedCampaignPerformanceChartProps {
  data: ChartDataPoint[];
  /** Chart title */
  title?: string;
...
/**
 * MigratedCampaignPerformanceChart - Using Design System tokens and CAMPAIGN_COLORS
 * 
 * Changes from legacy:
 ...
 */
const MigratedCampaignPerformanceChart: React.FC<MigratedCampaignPerformanceChartProps> = ({
  data,
...
export default MigratedCampaignPerformanceChart;
