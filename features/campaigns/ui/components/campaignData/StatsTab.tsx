...
const CustomTooltip = ({
  ...
  if (active && payload && payload.length) {
    ...
    return (
      <div className="bg-white dark:bg-card border border-gray-200 dark:border-border rounded-lg shadow-lg p-3 min-w-36">
...
function StatsTab() {
  ...
  const [metrics, setMetrics] = useState<MetricToggle[]>([
    { key: "sent", label: "Emails Sent", color: CAMPAIGN_COLORS.sent, visible: true },
    {
      key: "opened",
      label: "Opens (Tracked)",
      color: CAMPAIGN_COLORS.opens,
      visible: true,
    },
    { key: "replied", label: "Replies", color: CAMPAIGN_COLORS.replies, visible: true },
    {
      key: "clicked",
      label: "Clicks (Tracked)",
      color: CAMPAIGN_COLORS.clicks,
      visible: true,
    },
    { key: "bounced", label: "Bounces", color: CAMPAIGN_COLORS.bounces, visible: true },
  ]);
