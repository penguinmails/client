...
export interface MigratedCampaignsFilterProps {
...
/**
 * MigratedCampaignsFilter - Filter bar matching legacy visual appearance
 * 
 * Uses DS components while maintaining the exact same layout and styling
 * as the legacy CampaignsFilter for visual parity.
 */
export function MigratedCampaignsFilter({
  onSearch,
  onStatusChange,
  onDateRangeChange,
  onMailboxChange,
  className,
}: MigratedCampaignsFilterProps) {
...
export default MigratedCampaignsFilter;
