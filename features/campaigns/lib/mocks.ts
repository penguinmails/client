 ...
 * Campaigns Mock Data
 * 
 * Mock data for campaigns feature testing and development
 */

// Simple mock provider for campaigns data
...
export const mockCampaignProvider = new SimpleMockProvider(campaignsData);
