...
services:
  niledb:
    ...
    volumes:
      - nile_data:/var/lib/postgresql/data # Optional persistent storage
...
```bash
sudo docker logs client-niledb-1
```
...
```bash
psql -h localhost -p 5443 -U 00000000-0000-0000-0000-000000000000 -d test
```
...
1. Enter the container shell:
   ...
   ```bash
   sudo docker exec -it client-niledb-1 bash
   ```

2. Inside the container, connect to the database:
   ```bash
   psql -U 00000000-0000-0000-0000-000000000000 -d test
   ```
