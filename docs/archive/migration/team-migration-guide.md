...
> **⚠️ ARCHIVED DOCUMENT**: This guide was created during the FSD migration process and is now archived. The documentation structure and links referenced in this guide may no longer be current. For current documentation, please refer to the main docs directory.
...
3. Check component-specific issues: [`docs/troubleshooting/README.md`](../../troubleshooting/README.md)
