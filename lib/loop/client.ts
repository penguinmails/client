...
class LoopService {
  ...
  async sendTransactionalEmail(emailData: LoopTransactionalEmail): Promise<LoopResponse> {
    try {
      ...
      productionLogger.error('Loop transactional email error:', error);
      return {
        success: false,
  ...
  async createContact(contact: LoopContact): Promise<LoopResponse> {
    try {
      ...
      productionLogger.error('Loop create contact error:', error);
      return {
        success: false,
        message: error instanceof Error ? error.message : 'Unknown error occurred',
      };
  ...
  async deleteContact(email: string): Promise<LoopResponse> {
    try {
      ...
      productionLogger.error('Loop delete contact error:', error);
      return {
        success: false,
        message: error instanceof Error ? error.message : 'Unknown error occurred',
      };
