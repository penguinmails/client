    ...
    async () => {
      return await withAuth(async (_context) => {
        return await withErrorHandling(async () => {
          ...
          //   data: { ...paymentMethod, userId: context.userId, stripeId: stripePaymentMethod.id }
          // });
...
export async function removePaymentMethod(
  ...
  return await withContextualRateLimit(
    ...
    'user',
    RateLimits.PAYMENT_METHOD_DELETE,
    async () => {
      return await withAuth(async (_context) => {
        return await withErrorHandling(async () => {
          ...
          // await db.paymentMethods.delete({ where: { id: paymentMethodId, userId: context.userId } });
    ...
    async () => {
      return await withAuth(async (_context) => {
        return await withErrorHandling(async () => {
          ...
          //   where: { id: paymentMethodId, userId: context.userId },
          //   data: updates
          // });
