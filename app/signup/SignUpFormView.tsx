...
export default function SignUpFormView() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      try {
        const verificationResponse = await fetch('/api/emails/send', {
          method: 'POST',
          headers: {
          ...
          body: JSON.stringify({
            type: 'verification',
            email: data.email,
            userName: data.email.split('@')[0], // Use email prefix as default name
            token: 'temp-token', // This will be generated by the backend
          }),
        });
