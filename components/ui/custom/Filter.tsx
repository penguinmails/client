...
function SearchInput({
  ...
  return (
    <div className="flex items-center space-x-2 border-input border shadow-sm rounded-lg px-2 bg-background dark:bg-muted/50 peer-focus-within:border-ring-primary focus-within:ring-1 focus-within:ring-primary w-full lg:w-auto">
