...
// Type for formatter function to avoid using any
type FormatterValue = number | string;
type FormatterName = string;
type FormatterFunction = (
  value: FormatterValue,
  name: FormatterName,
  props: ChartTooltipPayloadItem,
  index: number,
  payload: unknown
) => React.ReactNode;
    ...
    if (labelFormatter) {
      return (
        <div className={cn("font-medium", labelClassName)}>
          {labelFormatter(value, payload as ChartTooltipPayloadItem[])}
        </div>
      );
    }
          ...
          return (
            ...
            >
              {formatter && item?.value !== undefined && item.name ? (
                (formatter as FormatterFunction)(
                  item.value,
                  item.name,
                  item,
                  index,
